...
export const config = {
    matcher: [
        "/((?!api|admin|fonts|assets|_next/static|_ipx|_next/image|favicon.ico|apple-icon.png|icon.png|googlefea46182bb61c886.html|robots.txt|sitemap.yml|sitemap.xml).*)"
    ]
};
