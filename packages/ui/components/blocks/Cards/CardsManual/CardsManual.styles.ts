...
const defaultStyles = {
    ...
    card: "group relative bg-primary overflow-hidden flex justify-center items-center",
    box: "h-m4 xs:w-m6 xs:h-m4 sm:w-m8 sm:h-m5",
    content: "absolute z-10 inset-0 h-full px-16 pt-8 pb-16 flex flex-col justify-between gap-8 text-on-primary",
    titleWrapper: "grow shrink min-h-0",
    title: "typo-title-sm md:typo-title trim-line hyphens-auto sm:hyphens-none line-clamp-4 xs:line-clamp-5 lg:line-clamp-6",
    subtitleWrapper: "",
